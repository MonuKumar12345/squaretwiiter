...
$aUsers = $oUser->gellAllUserNotFollowing($_SESSION['aUserData']['user_id']);
?>
                        ...
                        <div class="card">
                            ...
                            <div class="text-center">
                                <form action="" method="post">
                                    <button type="submit" class="btn form-control text-white" name="following" value=<?php echo $user['user_id'] ?>>Follow</button>
                                </form>                            
                            </div>
                        </div>
                    </div>
